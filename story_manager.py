...
class Story_Manager:
    def __init__(self, user_name='USER') -> None:
        ...
        self.stories = [
            ...
            story.simple_msg_maker(5, msg='死定了', button_label='???發生什麼事', text_after_clicked='???發生什麼事!', sender_name=None),
            story.Welcome2(username=user_name),  
            story.simple_msg_maker(10, msg='真的可以嗎?', button_label='但是', text_after_clicked='但我要怎麼幫啊?'), 
            ...
            story.simple_msg_maker(45, msg='你等我講完，答案是聖經裡的一個名詞\n我還留著當時的題目！翻到了！痾不過，沒有答案欸🤪', button_label='.....又來!', text_after_clicked='.....又來!你的筆記要不是看不懂，就是缺漏...'),
            story.Question2(), 
            story.simple_msg_maker(50, msg='對了！我想把八福也加入這次的信息', button_label='可以呀!', text_after_clicked='可以呀!但是你要怎麼帶?\n難道你要準備講章?'), 
            story.simple_msg_maker(55, msg='怎麼可能，講章太像上課一定沒人理我😤\n我打算仿造之前玩過的解謎，讓大家動動腦', button_label='好啊!', text_after_clicked='好啊!設計完傳給我'),
            story.Question4(),
            story.simple_msg_maker(60, msg='趁你剛剛解題的時候，我又想到了一題', button_label='真的假的?', text_after_clicked='真的假的?到底是你出題太快還是我解題太慢?'), 
            story.Question5(),
            story.simple_msg_maker(65, msg='對了欸！不錯嘛！題目沒問題吧？', button_label='嗯嗯!', text_after_clicked='嗯嗯! 只是好奇你上面的圖片哪來的?總不可能是你自己畫的吧'), 
            story.simple_msg_maker(70, msg='那當然不是啊！是得到了民間高手的幫助', button_label='我就說!', text_after_clicked='我就說!難怪這麼精美'), 
